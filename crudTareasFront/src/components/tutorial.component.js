  ...
  updateStatus(status) {
    ...
    this.props
      ...
      .then((reponse) => {
        ...
        this.setState({ message: "El estado de Vigencia se ha modificado!" });
      })
      .catch((e) => {
        console.log(e);
      });
  ...
  updateContent() {
    this.props
      ...
      .then((reponse) => {
        ...
        this.setState({ message: "La Tarea ha sido Actualizada!" });
      })
      .catch((e) => {
        console.log(e);
      });
        ...
        {currentTutorial ? (
          <div className="edit-form">
            ...
            <form>
              ...
              <div className="form-group">
                <label htmlFor="title">Fecha de Creación</label>
                <input
                  type="text"
                  className="form-control"
                  id="title"
